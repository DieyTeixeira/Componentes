...
package com.dieyteixeira.componentes.ui.components.animated_stop_watch
...
/*-------------------------------------------------------------------------------------------------|
|                                                                                                  |
|                              ANIMAÇÃO DE CONTAGEM "CRONÔMETRO"                                   |
|                                                                                                  |
|------------------------------------------------------------------------------------------------ */

@ExperimentalAnimationApi
@Composable
fun AnimatedStopWatch(mainViewModel: MainViewModel = viewModel()) {
...
@Preview
@Composable
private fun AnimatedStopWatchPreview() {
    AnimatedStopWatch()
}